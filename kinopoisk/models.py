...
class Movie(models.Model):
    ...
    year_of_publishing = models.PositiveSmallIntegerField(verbose_name="Год выпуска", validators=[validate_year])
    rating = models.DecimalField(verbose_name="Рейтинг", max_digits=4, decimal_places=2,
        validators=[
